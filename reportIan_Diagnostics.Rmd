...
```{r Error constancy, tidy=FALSE, results="hide", fig.width=5, fig.height=3}
...
```{r non-normality, fig.width=5, fig.height=3, echo=TRUE, results="hide"}
par(mfrow=c(1, 2))
...
```{r Serial correlation, results="hide", fig.width=5, fig.height=3}
...
The R squared and the p-values show that this result is significant, and we can conclude that there is marked autocorrelation among the residuals. We address this issue using transformations of the response. 
