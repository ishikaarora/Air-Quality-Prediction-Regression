...
```{r Loading data}
#Loading data
data <- read.csv("data/data_nomiss.csv")
...
#Fitting full model
full.lmod <- lm(formula = AQI ~ Nitrous.Oxide + NF3 + Other.GHG + Total.Emissions + HFC + Other.Fluorane + 
    Biogenic.CO2 + Population + CO2 + PFC + HFE + Stationary.Combustion + pp_consumed_MMBtu + Temperature +  
    Methane + SF6 + Short.Lived.Compounds + Income +  pp_net_gen_MWh, data = data)
